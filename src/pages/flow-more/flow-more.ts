...
/**
 * Generated class for the FlowMorePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-flow-more',
  templateUrl: 'flow-more.html',
})
export class FlowMorePage extends BasePage{
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FlowMorePage');
    this.initState();
    this.queryUnit();
  }
