...
public class TimePopupWindow extends PopupWindow implements OnClickListener ,View.OnTouchListener{
	...
	public TimePopupWindow(Context context, Type type) {
		...
		rootView = mLayoutInflater.inflate(R.layout.pickerview_pw_time, null);
		// -----确定和取消按钮
	...
	public void setHourRange(int START_HOUR, int END_HOUR) {

		wheelTime.setSTART_HOUR(START_HOUR);
		wheelTime.setEND_HOUR(END_HOUR);
	}
