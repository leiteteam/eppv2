package com.androidcat.utilities.qnyupload.utils;
...
public final class Auth {
    ...
    //mi:服务器时间
    public String uploadToken(String bucket,long mi){
        long deadline = mi+ 3600;
        return uploadTokenWithDeadline(bucket, null, deadline, null, true);
    }
