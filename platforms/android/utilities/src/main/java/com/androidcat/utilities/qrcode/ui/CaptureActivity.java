package com.androidcat.utilities.qrcode.ui;
...
import com.androidcat.utilities.qrcode.decode.CaptureActivityHandler;
import com.androidcat.utilities.qrcode.decode.InactivityTimer;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void handleDecode(String qrCodeString) {
		...
		// 将解码信息传递给前画面
		// TODO: 2017-9-1 add intent
		/*Intent data = new Intent(this, UnlockingActivity.class);
		startActivity(data);*/
	...
	public ImageScanner getmImageScanner(){
