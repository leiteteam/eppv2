...
import com.androidcat.utilities.qnyupload.storage.UpCancellationSignal;
import com.androidcat.utilities.qnyupload.utils.AsyncRun;
...
//    }
    ...
    public ResponseInfo send(final Request.Builder requestBuilder, StringMap headers) {
        ...
        try {
            ...
            e.printStackTrace();
            return new ResponseInfo(null, ResponseInfo.NetworkError, "", "", "",
