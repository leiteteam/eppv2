...
final class FlashlightManager {
  ...
  static {
    ...
    if (iHardwareService == null) {
      LogUtil.d(TAG, "This device does supports control of a flashlight");
    } else {
    	LogUtil.d(TAG, "This device does not support control of a flashlight");
    }
  }
...
//      LogUtil.d(TAG, "Unexpected error while finding class " + name, re);
      return null;
    }
  }
...
//      LogUtil.d(TAG, "Unexpected error while finding method " + name, re);
      return null;
    }
  }
...
//      LogUtil.d(TAG, "Unexpected error while invoking " + method, e);
      return null;
    } catch (InvocationTargetException e) {
//      LogUtil.d(TAG, "Unexpected error while invoking " + method, e.getCause());
      return null;
    } catch (RuntimeException re) {
//      LogUtil.d(TAG, "Unexpected error while invoking " + method, re);
      return null;
    }
  }
