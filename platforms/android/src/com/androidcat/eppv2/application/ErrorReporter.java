...
import com.androidcat.eppv2.ui.Crashctivity;
...
public class ErrorReporter implements UncaughtExceptionHandler {
    ...
    void handleException(Throwable e) {
        try {
          ...
          Logger.file(sb.toString(),false);
          LogUtil.e("crash","发生crash");
    ...
    private void showCrash(){
      final Intent intent = new Intent(mApplication, Crashctivity.class);
